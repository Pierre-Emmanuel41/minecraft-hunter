...
public enum EHunterMessageCode implements IMinecraftMessageCode {
	...
	IS_HUNTER_DISTANCE_DISPLAYED__EXPLANATION, IS_HUNTER_DISTANCE_DISPLAYED__VALUE_IS_MISSING, IS_HUNTER_DISTANCE_DISPLAYED__VALUE_DEFINED,
	...
	// Code for command minimumDistance
	HUNTER_MINIMUM_DISTANCE__EXPLANATION, HUNTER_MINIMUM_DISTANCE__ON_TAB_COMPLETE, HUNTER_MINIMUM_DISTANCE__DISTANCE_IS_MISSING,
	HUNTER_MINIMUM_DISTANCE__DISTANCE_MUST_BE_POSITIVE, HUNTER_MINIMUM_DISTANCE__DISTANCE_DEFINED,

	// Code for command decay
	HUNTER_DECAY__EXPLANATION, HUNTER_DECAY__ON_TAB_COMPLETE, HUNTER_DECAY__VALUE_IS_MISSING, HUNTER_DECAY__DECAY_VALUE_MUST_BE_GREATER_THAN_ONE,
	HUNTER_DECAY__VALUE_DEFINED,

	// Code for in game messages
	HUNTER_NOT_ENOUGH_PLAYERS, HUNTER_OVERWORLD_BORDER_IS_MISSING(Permission.SENDER), HUNTER_PVP_ENABLED(Permission.ALL), HUNTER_NO_RESURRECTION(Permission.ALL),
